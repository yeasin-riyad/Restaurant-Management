...
const TopMiddle = () => {
  ...
  return (
    <div className={"relative"}>
        <MiddleContainer >
      <div className={"flex flex-col items-start gap-x-6 relative lg:flex-row"}>
        <div className="relative">
          <img
        ...
        <div className="flex flex-col">
          ...
          <div>
            ...
            <div className="flex gap-x-7 items-center my-4 lg:my-6">
              <NavbarButton className={"py-4  "} text={"ABOUT MORE"} />
      ...
      <div className=" flex mt-4 flex-col justify-center gap-y-6  items-start lg:flex-row lg:justify-between lg:items-center lg:mt-16">
        ...
        <LittleComponent img="https://i.ibb.co.com/hMD6Zbw/medal.png"
        alt={"Medal"}
        heading={"ABSOLUTE DINING"}
        para="Best buffet restaurant"/>

        <LittleComponent img={"https://i.ibb.co.com/85h0KtQ/bag.png"}
        alt={"Medal"}
    ...
    <img className="absolute right-0 bottom-48 hidden w-24 lg:block" src="https://i.ibb.co.com/1dY1pjk/top-view-bell-pepper-pepper-sliced-black-bowl-white-horizontal-2.png" alt="side-bowl" />
